...
namespace InstagramAppExercise.Model
{
	public class UserService
	{
        ...
        //Quitamos el public, y usamos el internal para que el compilador no se queje
        internal User GetUser(int userId) => _users.SingleOrDefault(u => u.Id == userId);
    }
}
